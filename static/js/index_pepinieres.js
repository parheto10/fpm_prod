...
Promise.all([
  fetch("https://akidompro.pythonanywhere.com/api/v1/map_pepinieres/"),
...
//   console.log(data1);
  ...
  //url = "https://akidompro.pythonanywhere.com/api/v1/map_pepinieres/";
          ...
          <table class="table table-striped table-bordered">
            ...
            <tbody style="align-items: center">
                ...
                <td class="text-uppercase text-center">
                    <a class="btn btn-success" href="#" onclick="show_semence('https://akidompro.pythonanywhere.com/semence_by_pepiniere/${id}')" target="_blank"  role="button"><i class="glyphicon glyphicon-tree-deciduous"></i></a>
                </td>
            </tr>
            </tbody>
          </table>
