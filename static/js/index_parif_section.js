function viewMapSection(id ,url){
    event.preventDefault();
    $('#recherche').val("");

        var id_coop = $("#cooperative").val();
        ...
        $.ajax({
            ...
            success:function(response){
              ...
              if(response.id != "" && response.id_coop != ""){
                ...
                Promise.all([
                  fetch("https://akidompro.pythonanywhere.com/api/v1/section_parcelles/"+response.id),
                ...
                Promise.all([
                  fetch("https://akidompro.pythonanywhere.com/api/v1/coop_parcelles/"+response.id_coop),
                ]).then(async ([response1]) => {
                  const responseData1 = await response1.json();
                  //  const responseData2 = await response2.json();
