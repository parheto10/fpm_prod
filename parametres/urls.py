...
urlpatterns = [
 ...
 #Export to Excel
   ...
   path('api/v1/map_plantings_espece/<str:code>', map_plantings_espece, name='map_plantings_espece'),
   path('show_monitoring/<str:code>', show_monitoring, name='show_monitoring'),
#   path('api/planting/v1/', PlantingParifApiView.as_view(), name="plantingParif_api"),
   path('api/planting/v1/', api_planting, name="plantingParif_api"),
   path('api/coop_planting/v1/<str:code>', api_detail_cooperative, name="coop_plantingParif_api"),
   ...
   path('show_planting/<str:code>', show_planting, name='show_planting'),
